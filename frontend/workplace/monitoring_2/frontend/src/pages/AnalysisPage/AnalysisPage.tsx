...
import { CorrelationChart, CorrelationDataPoint } from '../../components/Charts/CorrelationChart';
      ...
      <div className="card">
        <div className="card-hd">
          ...
          <div className="card-actions">
            <select className="card-select" defaultValue="24h">
        ...
        <div className="card">
          ...
          <div className="card-bd">
              ...
              <div className="video-frame">
                <div className="video-placeholder">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                    ...
                    <path d="M2 16l5-5 3 3" />
                  </svg>
                  <span>기준 영상</span>
                  <small>2024-01-15 10:00:00</small>
                </div>
              </div>
              <div className="video-frame">
                <div className="video-placeholder">
                  ...
                  <span>비교 영상</span>
                  <small>2024-01-15 11:00:00</small>
                </div>
              </div>
            </div>
            <div className="video-controls">
              ...
              <button className="btn btn-sm btn-secondary">차이점 분석</button>
            </div>
          </div>
        </div>
      </div>
